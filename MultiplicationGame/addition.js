    ...
    action = setInterval(function(){
        ...
        {//game over
            ...
            if(flag==1){
                // flag=0;
                if(score>score1){
                document.getElementById("gameover").innerHTML= "<p>Player 2 Won !!<br> WITH SCORE is : " + score+ "</p>";
                // break;
                ...
                document.getElementById("gameover").innerHTML= "<p>Player 1 Won !! <br> WITH SCORE: " + score1+ "</p>";
                // break;
                document.getElementById("start").innerHTML = "Play again";
...
//generate question and answers 
    ...
    function generateQA(){
        ...
        document.getElementById("problem").innerHTML=randomNumber1+ " + " +randomNumber2+ " + " +randomNumber3;
